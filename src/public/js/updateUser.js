...
function updateUserInfo() {
  ...
  $("#input-change-username").bind("change", function () {
    ...
    if (!regexUsername.test(username) || username.length < 3 || username.length > 17) {
      alertify.notify("Username phải có giới hạn trong khoảng 3-17 ký tự và không có chứa ký tự đặc biệt", "error", 7);
  ...
  $("#input-change-gender-male").bind("click", function () {
    ...
    if (gender !== "male")
    {
      alertify.notify("Opps! Dữ liệu giới tính bạn có vấn đề, bạn sửa inspect chăng ?", "error", 7);
  ...
  $("#input-change-gender-female").bind("click", function () {
    ...
    if (gender !== "female")
    {
      alertify.notify("Opps! Dữ liệu giới tính bạn có vấn đề, bạn sửa inspet chăng ?", "error", 7);
      $(this).val(originUserInfo.gender);
      delete userInfo.gender;
      return false;
    }
  ...
  $("#input-change-address").bind("change", function () {
    ...
    {
      alertify.notify("Địa chỉ phải nằm trong khoảng 3-30 ký tự", "error", 7); 
  ...
  $("#input-change-phone").bind("change", function () {
    ...
    if (!regexPhone.test(phone)) {
      alertify.notify("Số điện thoại Việt Nam bắt đầu từ 0, giới hạn trong khoảng 10-11 ký tự", "error", 7);
